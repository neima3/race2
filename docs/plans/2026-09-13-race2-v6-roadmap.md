...
- [x] Phase 6: Release QA + v2.1.0 + deploy + live verify *(balance pass + QA sweep + v2.1.0 committed; Coolify deploy + live verify still pending — deploy is the only remaining step)*
