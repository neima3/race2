...
- `game/career.ts` — 4 cups: SPRINT (easy+easy+mid, forgiving), STREET (mid+pro+pro, medium — autopilot lands silver), GAUNTLET (pro+pro+mid, spicy), GRAND TOUR (easy+mid+pro across salt-flats/harbor-nine/ring-runner/serpents-tail with day/night/dusk/rain — all 4 variants in play); cup tier mixes are roster-capacity-guarded (pro roster = 2, a third pro slot would duplicate APEX)
